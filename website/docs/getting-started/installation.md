...
1. [**Quick start with the wizard**](/getting-started/wizard) — `hortval init` produces a valid configuration and offers to either open a cold-start window or install / register your license.
