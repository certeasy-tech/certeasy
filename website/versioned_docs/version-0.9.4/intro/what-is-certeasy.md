...
Same product, same team, new name. The release documented here — **0.9.4** — is
the one you can install today, and its binary and commands are still named
`certeasy`. The name changes with the next release.
:::
